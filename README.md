...
For details, see framework/.

1.5 Visual Overview


2. Apply to a Stock
Use the analysis template to analyze any stock:

Draw the supply chain map
Identify the bottleneck
Screen companies
Size your position
Set thesis validation checkpoints
3. Study the Case
Read the $AAOI Case Study to see how Serenity applied this framework in practice.
...
设置 thesis 验证检查点
3. 学习案例
阅读$AAOI 案例分析，看看 Serenity 如何在实践中应用这个框架。
...
Add framework pyramid diagram to README
